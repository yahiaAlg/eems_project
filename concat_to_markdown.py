...
DEFAULTS: dict[str, tuple[str, str]] = {
    ...
    "api_views": (
        "docs/master_backend/api_views",
        "docs/master_backend/api_views/master_api_views.md",
    ),
    "api_urls": (
        "docs/master_backend/api_urls",
        "docs/master_backend/api_urls/master_api_urls.md",
    ),
}
# ───────────────────────────────────────────────────────────────────────────────
